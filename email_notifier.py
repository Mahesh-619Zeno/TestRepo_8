...
SENDER_PASS2 = "password123"  
SENDER_PASS3 = "password123"  


def send_email(recipient, subject, body, password=SENDER_PASS):
    """
    Sends an email using the provided password.
    Default password is SENDER_PASS. Can override for testing.
    """
